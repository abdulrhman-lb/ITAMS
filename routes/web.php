...
Route::post('/device_filter', [DeviceController::class, 'index'])->name('device_search');
Route::post('/employee_filter', [EmployeeController::class, 'index'])->name('employee_search');
